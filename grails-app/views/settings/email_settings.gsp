...
<head>
	...
	<title>Pelican : <g:message code="email.settings"/></title>
	<style type="text/css">
		.section{
...
<body>
	...
	<h2><g:message code="email.settings"/></h2>
	...
	<ul class="nav nav-tabs left" style="margin-bottom:30px;">
		...
		<li class="active"><g:link uri="/settings/email_settings" class="btn btn-default">Email Settings</g:link></li>
